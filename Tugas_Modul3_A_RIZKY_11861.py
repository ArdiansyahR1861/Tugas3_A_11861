...
st.markdown("<h1 style='text-align: center; color: #4CAF50;'>Prediksi IPK - 1861</h1>", unsafe_allow_html=True)
...
if uploaded_file is not None:
    ...
    model_directory = r'D:\KAMPUS LIK OJO KESET\MESIN LERNING\Supervised Learning\Model Suprevised Learning (Praktek)\Tugas3_A_11861'
